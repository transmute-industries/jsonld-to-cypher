...
# Generated Cypher
```cypher
CREATE ( g:Graph { uri: "urn:uuid:1e61e0e0-ee5e-4767-8481-81179d382336:_:c14n1" } )
...
MERGE ( n14 :Resource { uri: "https://w3id.org/security#proofPurpose" } )
MERGE ( n15 :Resource { uri: "https://w3id.org/security#assertionMethod" } )
MERGE ( n16 :Resource { uri: "did:key:z6MktiSzqF9kqwdU8VkdBKx56EYzXfpgnNPUAGznpicNiWfn#z6MktiSzqF9kqwdU8VkdBKx56EYzXfpgnNPUAGznpicNiWfn" } )
...
CREATE (n0)-[e5: CREDENTIAL_STATUS ]->(n1)
CREATE (n0)-[e6: SUBJECT ]->(n7)
CREATE (n0)-[e7: ISSUANCE_DATE ]->(n8)
CREATE (n0)-[e8: ISSUER ]->(n9)
CREATE (n10)-[e9: HAS ]->(n11)
CREATE (n10)-[e10: TYPE ]->(n12)
CREATE (n10)-[e11: HAS ]->(n13)
CREATE (n14)-[e12: ASSERTION_METHOD ]->(n15)
CREATE (n10)-[e13: VERIFICATION_METHOD ]->(n16)
CREATE (g)-[nge: CONTAINS ]->(n10)
RETURN g,n0,n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16
```